#!/usr/bin/env node
// Table-driven self-test for the `publish-marketplace` composite action
// (.github/actions/publish-marketplace/), called identically by
// sethbacon/azure-pipelines-terraform, sethbacon/azure-pipelines-packer and
// sethbacon/azure-pipelines-release-docs. Drives the REAL script at
// github.action_path -- the same file every consumer's pinned SHA resolves to
...
const scriptPath = path.join(repoRoot, '.github', 'actions', 'publish-marketplace', 'publish-marketplace.js');
